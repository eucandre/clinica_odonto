# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2017-09-05 01:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('active', models.BooleanField()),
                ('note', models.TextField()),
                ('name_client', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_contrato.Contrato_Filiado_A_Empresa')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            name='relatorio_exame_nutri_continuado',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
        ...
        migrations.CreateModel(
            name='relatorio_exame_odonto_continuado',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('evulution', models.CharField(choices=[('Bom', 'Bom'), ('Ruim', 'Ruim'), ('Regular', 'Regular'), ('Otimo', 'Otimo')], help_text='Classifica a evolucao do tratamento do paciente', max_length=7)),
                ('date_atendence', models.DateField()),
                ('date_now', models.DateField(auto_now=True)),
                ('image_register', models.ImageField(blank=True, null=True, upload_to='documents/relatorio/exame/%Y/%m/%d')),
                ('note', models.TextField()),
                ('faces_tooths', models.ManyToManyField(to='app_receita.FacesDentes')),
                ('name_client', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_contrato.Contrato_odonto')),
                ('tooths', models.ManyToManyField(to='app_receita.Dentes')),
        ...
        migrations.CreateModel(
            name='relatorio_exame_psico_continuado',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('evulution', models.CharField(choices=[('Bom', 'Bom'), ('Ruim', 'Ruim'), ('Regular', 'Regular'), ('Otimo', 'Otimo')], help_text='Classifica a evolucao do tratamento do paciente', max_length=7)),
                ('date_atendence', models.DateField()),
